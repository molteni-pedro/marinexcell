...
class Manager extends \Jet_Engine_Base_WP_Intance {
	...
	public function register_instances() {
		...
		add_action( 'jet-engine/relation/update/after', 'wp_cache_flush' );
		add_action( 'jet-engine/relation/delete/after', 'wp_cache_flush' );
		add_action( 'jet-engine/relation/update-all-meta/after', 'wp_cache_flush' );
