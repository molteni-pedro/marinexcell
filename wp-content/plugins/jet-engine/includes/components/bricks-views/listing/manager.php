...
class Manager {
	...
	public function __construct() {
		...
		add_action( 'jet-engine/listing/grid-items/before', [ $this, 'actions_before_grid_items' ], 10 );
		add_action( 'jet-engine/listing/grid-items/after', [ $this, 'actions_after_grid_items' ], 10 );
